...
#import "PureWordViewController.h"

@interface PureWordViewController ()

@end

@implementation PureWordViewController
...
- (void)connectData{
    ...
    NSString *url = [NSString stringWithFormat:kPureWordURL,self.page];
