...
#import "PurePicViewController.h"

@interface PurePicViewController ()

@end

@implementation PurePicViewController
...
- (void)connectData{
    ...
    NSString *url = [NSString stringWithFormat:kPurePicURL,self.page];
